...
const props = defineProps({
    ...
    useBigImage: { type: Boolean, default: true },
...
<template>
    <div class="team-card" :class="{ compact }">
                        <div class="team-header">
                            <n-tag :type="roleType(team.role)" :bordered="false" size="small">
                                {{ roleLabel(team.role) }}
                            </n-tag>
                            <span class="team-extra" v-if="extra">{{ extra }}</span>
                            <span class="team-idu">
                            ...
                            <span class="team-time">{{ formatTime(team.last_time || team.time) }}</span>
                        </div>
